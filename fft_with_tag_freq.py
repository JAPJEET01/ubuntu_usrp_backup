...
class fft_with_tag_freq(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "fft_with_tag_freq")
        ...
        self.iridium_fft_burst_tagger_0 = iridium.fft_burst_tagger(100.6e6, 1024, int(samp_rate), 1000, 1000,
                                    100, 0, 0, 7, 512, False)
        ...
        # Connections
        ##################################################
        self.connect((self.iridium_fft_burst_tagger_0, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(100.6e6, self.samp_rate)
    ...
    #     self.qtgui_waterfall_sink_x_0.set_frequency_range(new_freq - self.samp_rate/2, new_freq + self.samp_rate/2)
...
def main(top_block_cls=fft_with_tag_freq, options=None):

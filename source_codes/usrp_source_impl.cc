...
usrp_source_impl::set_center_freq(const ::uhd::tune_request_t tune_request, size_t chan)
{
    ...
    _tag_now = true;
    // std::cout << "Tune Request: " << tune_request << "\n"; // Print the tune_request
        // Print each component of tune_request separately
    std::cout << "Tune Request: " << std::endl;
    std::cout << "Target Frequency: " << tune_request.target_freq << std::endl;
    std::cout << "Request Mode: " << tune_request.rf_freq_policy << std::endl;
    std::cout << "Dsp Frequency: " << tune_request.dsp_freq_policy << std::endl;
    // std::cout << "Args: " << tune_request.args << std::endl;
    return res;
}
